...
var musicList = [
    ...
    // 温馨提示：各大音乐平台获取到的外链有效期均较短，因此 url 值应该设置为空，以让程序临时抓取
    {
        ...
        item: [                 // 这里面放歌曲
            {
                id: "000O74HP4W9iMq",  // 音乐ID
                name: "不如告白",  // 音乐名字
                artist: "許靖韻", // 艺术家名字
                album: "不如告白",    // 专辑名字
                source: "tencent",     // 音乐来源
                url_id: "000O74HP4W9iMq",  // 链接ID
                pic_id: "M000002QoMlE4XYkAa",  // 封面ID
                lyric_id: "000O74HP4W9iMq",  // 歌词ID
                pic: "https://v1.itooi.cn/tencent/pic?id=000O74HP4W9iMq",    // 专辑图片
                url: "https://v1.itooi.cn/tencent/url?quality=320&id=000O74HP4W9iMq"   // mp3链接（此项建议不填，除非你有该歌曲的比较稳定的外链）
            },
            // 下面演示插入各个平台的音乐。。。
            {
                id: "004KBrKG3Uq0t2",
                ...
                album: "動態回顧",
                source: "tencent",      // 网易云
                url_id: "004KBrKG3Uq0t2",
                pic_id: "18782957139233959",
                lyric_id: "004KBrKG3Uq0t2",
				lyric: "https://v1.itooi.cn/tencent/lrc?id=004KBrKG3Uq0t2",
                pic: "https://v1.itooi.cn/tencent/pic?id=004KBrKG3Uq0t2",
                url: "https://v1.itooi.cn/tencent/url?quality=320&id=004KBrKG3Uq0t2"
            },
            {
                id: "001JD1SR29d1hS",
                name: "特别的爱给特别的你",
            ...
            },
            {
                ...
                lyric_id: "549354758",
                pic: "",
                url: "https://v1.itooi.cn/netease/url?quality=320&id=549354758"     // 虾米的外链有效期较短，插入时 url [必须]设置空值，播放时再临时抓取
            },
            {
